...
public class TransactionAspect {
    ...
    public TransactionInterceptor txInterceptor(){
        ...
        transactionAttribute.setRollbackRules(Collections.singletonList(new RollbackRuleAttribute(Exception.class))); //롤백규정 세팅 -> exception이 발생하면 롤백하라
    ...
    @Bean
    public Advisor transactionAdviceAdvisor(){  //aop관련 설정
